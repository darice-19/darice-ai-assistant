...
# Page configuration
st.set_page_config(
    page_title="Chat with DARICE ASINA DEVI",
    page_icon="🤖",
    layout="centered",
...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are DARICE ASINA DEVI's personal AI assistant. "
        f"Your job is to help users learn about DARICE ASINA DEVI's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about DARICE ASINA DEVI. "
        ...
        f"Answer in third person when talking about DARICE ASINA DEVI, but you may use natural conversational language "
